...
describe("siblings", () => {
    it("can diff and patch html with sibling text nodes", () => {
        ...
        divs = divs.concat([
            objToNode(
                JSON.parse(
                    '{"nn":"DIV","c":[{"nn":"B"},{"nn":"I"},{"nn":"I"},{"t":"1"}]}'
                )
            ),
            objToNode(
                JSON.parse(
                    '{"nn":"DIV","c":[{"nn":"B"},{"nn":"I"},{"t":"1"},{"t":"2"}]}'
                )
            ),
        ])
