...
interface PreDiffApplyOptions { // eslint-disable-line @typescript-eslint/no-unused-vars
    diff: Diff;
    node: anyNodeType;
}
...
interface PostDiffApplyOptions { // eslint-disable-line @typescript-eslint/no-unused-vars
    diff: Diff;
    node: anyNodeType;
    newNode: anyNodeType;
}
...
export { anyNodeType, DiffDOMOptions, nodeType, textNodeType }
